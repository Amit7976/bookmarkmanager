...
function Header() {
  return (
    <>
      <header className="flex flex-wrap  md:justify-start md:flex-nowrap z-50 w-full bg-white border-b border-gray-200 dark:bg-neutral-900 dark:border-neutral-700">
        <nav className="relative max-w-full w-full mx-auto md:flex md:items-center md:justify-between md:gap-3 py-3 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center gap-x-1">
            <Link
              className="flex-none rounded-md text-xl flex items-center gap-1 font-semibold focus:outline-none focus:opacity-80"
              href="/"
              aria-label="Bookmark"
            >
