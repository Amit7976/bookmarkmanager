      ...
      <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
          ...
          <ul className="text-center">
            ...
            <li className="inline-block relative pe-8 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-3 before:-translate-y-1/2 before:content-['/'] before:text-gray-300 dark:before:text-neutral-600">
              <Link
                className="inline-flex gap-x-2 text-sm text-blue-500 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-indigo-500 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                href="https://www.linkedin.com/in/amitgupta60600/"
              >
                Linkedin
              </Link>
            </li>
